...
class Assembly(ConfiguredBaseModel):
    ...
    phasing: Optional[PhasingApproach] = Field(default=None, description="""Phasing approach used to separate assembled sequences into distinct haplotypes, with or without parent-of-origin assignment.""", json_schema_extra = { "linkml_meta": {'alias': 'phasing', 'domain_of': ['Assembly']} })
