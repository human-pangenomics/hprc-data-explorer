...
class Assembly(ConfiguredBaseModel):
    ...
    phasing: Optional[PhasingApproach] = Field(default=..., description="""Phasing approach used to separate assembled sequences into distinct haplotypes, with or without parent-of-origin assignment.""", json_schema_extra = { "linkml_meta": {'alias': 'phasing', 'domain_of': ['Assembly']} })
    assembly_method: Optional[str] = Field(default=..., description="""Assembly method.""", json_schema_extra = { "linkml_meta": {'alias': 'assembly_method', 'domain_of': ['Assembly']} })
    assembly_method_version: Optional[str] = Field(default=..., description="""Assembly method version.""", json_schema_extra = { "linkml_meta": {'alias': 'assembly_method_version', 'domain_of': ['Assembly']} })
    assembly_date: Optional[str] = Field(default=..., description="""Date assembly was uploaded to Genbank (by convention).""", json_schema_extra = { "linkml_meta": {'alias': 'assembly_date', 'domain_of': ['Assembly']} })
    genbank_accession: Optional[str] = Field(default=..., description="""Genbank accession.""", json_schema_extra = { "linkml_meta": {'alias': 'genbank_accession', 'domain_of': ['Assembly']} })
    assembly_md5: Optional[str] = Field(default=..., description="""S3 URI to assembly MD5.""", json_schema_extra = { "linkml_meta": {'alias': 'assembly_md5', 'domain_of': ['Assembly']} })
    assembly_fai: Optional[str] = Field(default=..., description="""S3 URL to assembly FAI.""", json_schema_extra = { "linkml_meta": {'alias': 'assembly_fai', 'domain_of': ['Assembly']} })
    assembly_gzi: Optional[str] = Field(default=..., description="""S3 URI to assembly GZI.""", json_schema_extra = { "linkml_meta": {'alias': 'assembly_gzi', 'domain_of': ['Assembly']} })
