...
class Assembly(ConfiguredBaseModel):
    ...
    sample_id: str = Field(default=..., description="""Sample ID.""", json_schema_extra = { "linkml_meta": {'alias': 'sample_id', 'domain_of': ['Assembly']} })
    ...
    haplotype: int = Field(default=..., description="""Haplotype.""", ge=0, le=2, json_schema_extra = { "linkml_meta": {'alias': 'haplotype', 'domain_of': ['Assembly']} })
    ...
    assembly: str = Field(default=..., description="""S3 URI to assembly.""", json_schema_extra = { "linkml_meta": {'alias': 'assembly', 'domain_of': ['Assembly']} })
